...
class TasksFrame : JFrame() {
    ...
    private fun deleteAllButtonActionPerformed(evt: ActionEvent) {
        val answer = JOptionPane.showConfirmDialog(
            null,
    ...
    private fun printTasksButtonActionPerformed(evt: ActionEvent) {
        try {
            table.print()
    ...
    private fun addButtonActionPerformed(evt: ActionEvent) {
